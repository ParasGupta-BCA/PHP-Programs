 ...
 * Uses shared product catalog from MP01-products-data.php
 */
...
<body>
    <header class="page-header">
        <div class="header-content">
            <a href="MP01-home.php" class="brand">Prabhdeep <span>Mega Mart</span></a>
            <nav>
                <a href="MP01-orders-view.php" class="nav-link">My Orders</a>
            </nav>
        </div>
    </header>
    ...
    <div class="container">
            ...
            <div class="success-overlay">
                <div class="success-card">
                    ...
                    <div style="display: grid; gap: 12px;">
                        <a href="MP01-orders-view.php" class="btn-primary" style="text-decoration: none;">View Order Details</a>
                        <a href="MP01-shop-checkout.php" style="color: #666; text-decoration: none; font-size: 0.9rem; padding: 8px;">Back to Home</a>
                    </div>
                </div>
            </div>
        ...
        <?php else: ?>
            ...
            <form id="orderForm" method="POST" action="MP01-shop-checkout.php">
