...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['clear_data'])) {
    ...
    header("Location: MP01-orders-view.php"); // Refresh page
    exit;
}
...
<body>
    <div class="container">
        <header class="page-header">
            <div class="nav-top">
                <div class="nav-group">
                    <a href="MP01-home.php">← Home</a>
                    <a href="MP01-home.php" class="brand">Prabhdeep Mega Mart</a>
                </div>
                <div class="nav-group">
                    <a href="MP01-shop-checkout.php">Place Order</a>
                    <?php if (!empty($orders)): ?>
        ...
        <?php if (empty($orders)): ?>
            <div class="card empty-state">
                ...
                <a href="MP01-shop-checkout.php" class="btn">Go to Place Order</a>
            </div>
        <?php else: ?>
