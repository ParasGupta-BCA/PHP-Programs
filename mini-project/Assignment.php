...
<header class="header">
  <div class="wrap header-inner">
    <a href="Assignment.php" class="logo">Prabhdeep <b>Mega Mart</b></a>
    ...
    <nav class="nav">
        ...
        <a href="Assignment2.php" class="nav-item nav-cart">
...
<section class="hero">
  <div class="wrap hero-grid">
    <div class="hero-left">
        ...
        <div class="hero-btns">
            <a href="Assignment2.php" class="btn-shop btn-shop-primary">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"/></svg>
                Start Shopping
            </a>
            <a href="orders.php" class="btn-shop btn-shop-ghost">View Past Orders</a>
        </div>
...
<section class="section anim">
  <div class="wrap">
    <div class="sec-head">
        ...
        <a href="Assignment2.php" class="sec-link">See all <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><polyline points="9 18 15 12 9 6"/></svg></a>
    </div>
    <div class="cat-grid">
        <?php foreach ($categories as $cat): ?>
        <a href="Assignment2.php" class="cat-card">
...
<section class="section anim" style="padding-top:0">
  <div class="wrap">
    <div class="sec-head">
        ...
        <a href="Assignment2.php" class="sec-link">View all <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><polyline points="9 18 15 12 9 6"/></svg></a>
    </div>
    <div class="trend-grid">
        <?php foreach ($trending as $tp): ?>
        <a href="Assignment2.php" class="t-card">
            <div class="t-img">
    ...
    <div class="footer-grid">
        ...
        <div>
            ...
            <ul>
                ...
                <li><a href="Assignment2.php">Shop Now</a></li>
        ...
        <div>
            ...
            <ul>
                ...
                <li><a href="Assignment2.php"><?= htmlspecialchars($c['name']) ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
...
function renderResults(list, query) {
    ...
    list.forEach(p => {
        html += `
            <div class="result-item" onclick="location.href='Assignment2.php'">
